...
- 样本是具体人物，但本质目标是抽取共同 archetype 并扩展

目标：

- 输出共同 archetype、公开证据线索、相似人选扩展规则、推荐 source 与可触达路径
...
若任务已进入列举候选人、seed people 或相似人选阶段，输出统一结果集：
...
- GitHub
- 公司 / 产品 team page
- 产品发布页 / changelog / launch materials
- 个人博客 / 访谈 / conference page
...
- Hireclaw -> `talent-sourcing`
- Hireclaw -> 渠道 skill
- 渠道 skill 缺策略时 -> 回调 `talent-sourcing`
